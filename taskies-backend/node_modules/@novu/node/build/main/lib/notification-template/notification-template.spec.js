        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, novu.notificationTemplates.getAll(undefined, 0)];
                case 1:
                    _a.sent();
    ...
    test('should delete the specified template', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.notificationTemplates.delete('TEMPLATE_ID')];
                case 1:
                    _a.sent();
                    expect(mockedAxios.delete).toHaveBeenCalled();
                    expect(mockedAxios.delete).toHaveBeenCalledWith('/notification-templates/TEMPLATE_ID');
                    return [2];
            }
        });
    }); });
